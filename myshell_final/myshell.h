...
extern void addPID(int); // in 10_pidarray.c
extern void printArray(int a[]);// in 10_pidarray.c 
extern void killAllProcesses(void); // in 10_pidarray.c
extern bool isParent(int); // in 10_pidarray.c
extern void copyArray(int a[], int b[]); // in 10_pidarray.c
...
extern int processes[BUFSIZ];
extern int childArray[BUFSIZ];
extern int marker;
extern int retrieveArray[2];
